...
matlabFunction(angleDD.th1dd,'File','th1dd_EOM');
matlabFunction(angleDD.th2dd,'File','th2dd_EOM');
matlabFunction(angleDD.th3dd,'File','th3dd_EOM');
matlabFunction(angleDD.phi12dd,'File','phi12dd_EOM');
matlabFunction(angleDD.phi13dd,'File','phi13dd_EOM');
matlabFunction(angleDD.disdd_G1G2,'File','disdd_G1G2_EOM');
matlabFunction(angleDD.disdd_G1G3,'File','disdd_G1G3_EOM');
